...
Pod::Spec.new do |s|
  ...
  s.name         = "XTReq"
  s.version      = "0.0.1"
  s.summary      = "Based on AFNetworking and sqlite encapsulation, simple apis and persistent storage requests.."
  ...
  s.source       = { :git => "https://github.com/Akateason/XTReq", :tag => s.version }
