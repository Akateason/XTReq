...
@implementation XTDownloadOperation

#pragma mark - Observe Task

+ (instancetype)operationWithURLSessionTask:(XTDownloadTask *)task {
    XTDownloadOperation *operation = [XTDownloadOperation new];
    operation.task = task;
    return operation;
}
